...
static string ReshuffleBinary(string file1, int height, int width)
{
...
static void ArrowDown(int num, string array, int m, int n, ref int toWrite, string pixels)
{
    int x = num;
    int y = 0;
    if (num >= m)
...
static void ArrowUp(int num, string array, int m, int n, ref int toWrite, string pixels)
{
    int x = m - num - 1;
    int y = n - 1;
    if (x < 0)
...
// Sutaisymui:
static void Replace(string array, int height, int width)
{
...
static void SwapRows(string array, int a, int b, int width)
{
