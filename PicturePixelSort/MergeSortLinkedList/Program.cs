...
void MergeSort(DataLinkedList<int> list)
{
...
void Merge(DataLinkedList<int> list,
...
void Replace(DataLinkedList<int> list, int height, int width)
{
...
void SwapRows(DataLinkedList<int> list, int a, int b, int width)
{
    for (int i = 0; i < width; i++)
        list.Swap(a * width + i, b * width + i);
}

DataLinkedList<int> Reshuffle(DataLinkedList<int> list, int height, int width)
{
...
void ArrowDown(int num, DataLinkedList<int> list, int m, int n, ref int toWrite, ref Node<int> node)
{
    int x = num;
    int y = 0;
    if (num >= m)
...
void ArrowUp(int num, DataLinkedList<int> list, int m, int n, ref int toWrite, ref Node<int> node)
{
    int x = m - num - 1;
    int y = n - 1;
    if (x < 0)
