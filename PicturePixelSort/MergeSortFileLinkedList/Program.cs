...
static void PrintData(int ms, int size, string fileName)
{
...
// Istrizainems:
static void Replace(string list, int height, int width)
{
...
static void SwapRows(string list, int a, int b, int width)
{
    for (int i = 0; i < width; i++)
        f.Swap(list, a * width + i, b * width + i);
}

static string Reshuffle(string list, int height, int width)
{
...
static void ArrowDown(int num, string list, int m, int n, ref int toWrite, ref int node, string copy)
{
    int x = num;
    int y = 0;
    if (num >= m)
...
static void ArrowUp(int num, string list, int m, int n, ref int toWrite, ref int node, string copy)
{
    int x = m - num - 1;
    int y = n - 1;
    if (x < 0)
